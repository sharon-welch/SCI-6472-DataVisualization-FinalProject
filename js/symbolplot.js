class SymbolPlot {
   ...
   initVis(){
    ...
    updateVis(){
        ...
        vis.xScale.domain(d3.extent(vis.data, function (d) {return d.SaddleType}));

        vis.yScale.domain([(d3.min(vis.data, function (d)  {return d[selectedCategorySymbolY]})),
        ...
        vis.circles.enter()
            ...
            // })
            .attr("fill", "black")
            .attr("cx", d => vis.xScale(d.SaddleType))
